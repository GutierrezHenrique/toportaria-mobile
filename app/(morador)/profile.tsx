...
const s = StyleSheet.create({
  ...
  role: { color: theme.accent, marginTop: 12, fontSize: 12, letterSpacing: 2, textTransform: 'uppercase' },
  btn: { marginTop: 36, backgroundColor: theme.danger, paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12 },
});
